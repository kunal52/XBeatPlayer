...
public class PlayPauseDrawableDark extends Drawable {
    private static final long PLAY_PAUSE_ANIMATION_DURATION = 250;

    private static final Property<PlayPauseDrawableDark, Float> PROGRESS =
            new Property<PlayPauseDrawableDark, Float>(Float.class, "progress") {
                @Override
                public Float get(@NonNull PlayPauseDrawableDark d) {
                    return d.getProgress();
                }

                @Override
                public void set(@NonNull PlayPauseDrawableDark d, Float value) {
                    d.setProgress(value);
                }
            };
    ...
    public PlayPauseDrawableDark(@NonNull Context context) {
        final Resources res = context.getResources();
        paint.setAntiAlias(true);
        paint.setStyle(Paint.Style.FILL);
        paint.setColor(Util.getThemePrimaryColor(context));
