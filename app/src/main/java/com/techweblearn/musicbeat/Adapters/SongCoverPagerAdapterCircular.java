...
public class SongCoverPagerAdapterCircular extends CustomFragmentStatePagerAdapter {


    public static final String TAG = SongCoverPagerAdapterCircular.class.getSimpleName();
    static CallBacks callBack;
    private List<MediaBrowserCompat.MediaItem> songArrayList;

    public SongCoverPagerAdapterCircular(FragmentManager fm, List<MediaBrowserCompat.MediaItem> songArrayList) {
        super(fm);
    ...
    public static class SongCoverFragment extends Fragment {
        ...
        @BindView(R.id.song_image) CircleImageView imageView;
        Unbinder unbinder;
        ...
        public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            View view = inflater.inflate(R.layout.player_album_art_layout2, container, false);
