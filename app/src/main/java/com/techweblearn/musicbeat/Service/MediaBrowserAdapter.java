...
public class MediaBrowserAdapter  {
        ...
        if (mMediaBrowser == null) {
            mMediaBrowser =
                    new MediaBrowserCompat(
                            mContext,
                            new ComponentName(mContext, MusicPlayBackService.class),
     ...
     * any connections to the {@link MusicPlayBackService} happens via the {@link MediaSessionCompat}.
     */
    ...
    public class MediaControllerCallback extends MediaControllerCompat.Callback {
        ...
        public void onQueueChanged(final List<MediaSessionCompat.QueueItem> queue) {
            performOnAllListeners(new ListenerCommand() {
                @Override
                public void perform(@NonNull MediaBrowserChangeListener listener) {
                    listener.onQueueUpdated("Now Playing",queue);
                }
            });
        }
