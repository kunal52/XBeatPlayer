...
import com.techweblearn.musicbeat.Helper.SortOrder;
...
public class SongLoader {
    ...
    @NonNull
    public static Song getSong(@NonNull final Context context,@Nullable final int queryId) {
    ...
    public static Cursor makeSongCursor(@NonNull final Context context, @Nullable final String selection, final String[] selectionValues) {
        return makeSongCursor(context, selection, selectionValues, SortOrder.SongSortOrder.SONG_A_Z);
    }
