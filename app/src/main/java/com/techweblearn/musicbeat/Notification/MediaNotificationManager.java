...
package com.techweblearn.musicbeat.Notification;
...
public class MediaNotificationManager {
    ...
    public MediaNotificationManager(MusicPlayBackService service) {
        mService = service;
    ...
    public Notification getNotification(MediaDescriptionCompat metadata,
                                        @NonNull PlaybackStateCompat state,
                                        MediaSessionCompat.Token token) {
        boolean isPlaying = state.getState() == PlaybackStateCompat.STATE_PLAYING;
        MediaDescriptionCompat description = metadata;
        NotificationCompat.Builder builder =
                buildNotification(state, token, isPlaying, description);
        return builder.build();
    }

    public NotificationCompat.Builder buildNotification(@NonNull PlaybackStateCompat state,
                                                         MediaSessionCompat.Token token,
                                                         boolean isPlaying,
